        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                                ...
                                <form method="post">                                         
                                    <div class="col-lg-2">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" name="prod_id" required >                                                
                                            <?php
                                            $queryc = mysqli_query($con, "select id,description from rawdata_tb  WHERE type='RAW' ")or die(mysqli_error($con));
                ...
                <h1>
                    ...
                    <a class="btn btn-lg btn-primary" href="#add" data-target="#add" data-toggle="modal" style="color:#fff;" class="small-box-footer">Add New Raw  Data<i class="glyphicon glyphicon-plus text-blue"></i></a>
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title" style=" color: black"><b> 
                                            <?php
                                            $querycount = mysqli_query($con, "SELECT COUNT(id) AS norecords FROM `rawdata_tb`")or die(mysqli_error($con));
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                $query = mysqli_query($con, "SELECT * FROM  rawdata_tb INNER JOIN category ON category.cat_id= rawdata_tb.category_id  AND type='RAW' AND rawdata_tb.id='$prodId' LIMIT 10  ")or die(mysqli_error($con));
                                            } else {
                                                $query = mysqli_query($con, "SELECT * FROM  rawdata_tb INNER JOIN category ON category.cat_id= rawdata_tb.category_id  AND type='RAW'  LIMIT 10  ")or die(mysqli_error($con));
                                            }
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content" style="height:auto">
                                                        ...
                                                        <div class="modal-body" hidden="">
                                                            <form class="form-horizontal" method="post" action="delete-raw.php" enctype='multipart/form-data'>
                                                                <div class="form-group" hidden="hidden">
                                                                    <label class="control-label col-lg-3" for="price">Serial #</label>
                                                                    <div class="col-lg-9">
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="height:auto">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span></button>
                    <h4 class="modal-title">Add New Raw Data</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="product_add.php" enctype='multipart/form-data'>  
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3" for="name">Colour</label>
                            <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" required>  
                                <input type="text" class="form-control" name="colour" placeholder="Colour" autocomplete="off">  
                            </div>
                        </div>  
