...
<html>
    <head>
        ...
        <title>Warehouse Counts | <?php include('../dist/includes/title.php'); ?></title>
                        ...
                        <div class="col-md-15">
                            <div class="box box-primary angel">
                                ...
                                <div class="box-body">
                                    <form method="post">                                         
                                        <div class="col-lg-4">
                                            <label>Select Product in Warehouse</label>
                                            <select class="form-control select2" style="width: 100%;" name="cat_id" required >
                                                <option value="all">All Products</option>
                                                <?php
                                                $queryc = mysqli_query($con, "select * from ware_house_tb order by prod_name")or die(mysqli_error($con));
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-primary">
                                        <div class="box-header">
                                            <h3 class="box-title" style=" color: black"><b>Warehouse Count Report</b></h3>
                                        </div>                                      
                                        <div class="box-body">
                                            ...
                                            <table id="example2" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_POST['stock_count'])){
                                                        ...
                                                        if ($prod_id == 'all') {
                                                            $query = mysqli_query($con, "select * from ware_house_tb natural join supplier natural join category order by prod_name")or die(mysqli_error($con));
                                                        }else{
                                                            $query = mysqli_query($con, "select * from ware_house_tb natural join supplier natural join category HAVING ware_house_tb.prod_id='$prod_id' order by prod_name")or die(mysqli_error($con));
                                                        }
                                                    } else {
                                                        $query = mysqli_query($con, "select * from ware_house_tb natural join supplier natural join category order by prod_name")or die(mysqli_error($con));
                                                    }
