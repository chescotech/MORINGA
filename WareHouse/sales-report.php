                                                    ...
                                                    if (isset($_POST['display'])) {
                                                        ...
                                                        if ($cat_id != 'all' && $branch_id != 'all_branches') {
                                                            ...
                                                            $query = mysqli_query($con, "SELECT stock_branch_id,SUM(qty) AS qty,prod_name,prod_desc,name,sales_details.price AS prod_sell_price,sales.date_added  FROM sales_details INNER JOIN sales ON sales.sales_id=sales_details.sales_id INNER JOIN user ON user.user_id = sales.user_id INNER JOIN product ON product.prod_id = sales_details.prod_id AND "
                                                                    . "sales.date_added BETWEEN '$startDate' AND '$stop_date' AND product.stock_branch_id='$branch_id' AND product.cat_id='$cat_id' GROUP BY prod_name,stock_branch_id ")or die(mysqli_error($con));
                                                        } else if ($cat_id == 'all' && $branch_id != 'all_branches') {
                                                            $query = mysqli_query($con, "SELECT stock_branch_id,SUM(qty) AS qty,prod_name,prod_desc,name,sales_details.price AS prod_sell_price,sales.date_added  FROM sales_details INNER JOIN sales ON sales.sales_id=sales_details.sales_id INNER JOIN user ON user.user_id = sales.user_id INNER JOIN product ON product.prod_id = sales_details.prod_id AND "
                                                                    . "sales.date_added BETWEEN '$startDate' AND '$stop_date' AND product.stock_branch_id='$branch_id' GROUP BY prod_name,stock_branch_id ")or die(mysqli_error($con));
                                                        } else if ($cat_id != 'all' && $branch_id == 'all_branches') {
                                                            $query = mysqli_query($con, " SELECT stock_branch_id,SUM(qty) AS qty,prod_name,prod_desc,name,sales_details.price AS  "
                                                                    ...
                                                                    . "  GROUP BY prod_name ,stock_branch_id ")or die(mysqli_error($con));
                                                        } else {
