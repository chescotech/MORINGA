                            ...
                            <div class="col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <h3 class="box-title" style=" color: black"><b>Reverse / Cancel Order on Order # <?php echo $orderNumber; ?> </b></h3>
                                    </div>
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($con, "SELECT * FROM `sales_details` WHERE order_no='$orderNumber'")or die(mysqli_error($con));
                                                while ($row = mysqli_fetch_array($query)) {
                                                    $prod_d = $row['prod_id'];
                                                    $productQuery = mysqli_query($con, "SELECT * FROM product WHERE prod_id='$prod_d'")or die(mysqli_error($con));
                                                    $row2 = mysqli_fetch_array($productQuery)
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $row['qty']; ?></td>
                                                        <td><?php echo $row2['prod_name']; ?></td>
                                                        <td><?php echo $row2['prod_desc']; ?></td>
                                                        <td><?php echo number_format($row2['prod_sell_price'], 2); ?></td>
                                                        <td><?php
                                                            $totalPrice = $row2['prod_sell_price'] * $row['qty'];
