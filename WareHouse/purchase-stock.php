...
<?php
		$user_id = $_SESSION['id'];
		$query=mysqli_query($con,"select * from stock_purchases_tb INNER JOIN product ON product.prod_id=stock_purchases_tb.prod_id INNER JOIN supplier ON "
                        . " stock_purchases_tb.supplier_id=supplier.supplier_id AND status=''  ")or die(mysqli_error($con));
			$grand=0;
