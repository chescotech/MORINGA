                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <h3 class="box-title" style=" color: black"><b>Add New Item Category</b></h3>
                                    </div>
                                    <div class="box-body">
                                        <!-- Date range -->
                                        <form method="post" action="cat_add.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="date" style=" color: black"><b>Item Category</b></label>
                            ...
                            <div class="col-xs-8">
                                <div class="box box-primary">
                                    ...
                                    <div class="box-header">
                                        <h3 class="box-title" style=" color: black"><b>Category List</b></h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
                                                ...
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#delete<?php echo $row['cat_id']; ?>" data-target="#delete<?php echo $row['cat_id']; ?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-trash text-blue"></i></a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="height:auto">
                                                            ...
                                                            <div class="modal-body" hidden="">
                                                                <form class="form-horizontal" method="post" action="delete-category.php" enctype='multipart/form-data'>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-lg-3" for="name">Category</label>
                                                                        <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['cat_id']; ?>" required>  
                                                                            <input type="text" class="form-control" id="name" name="cat_id" value="<?php echo $row['cat_id']; ?>" required>  
                                                                        </div>
                                                                    </div> 
                                                            </div><hr>
                                                            <div class="modal-footer">
