...
<html>
    <head>
        ...
        <title>Discounts Report | <?php include('../dist/includes/title.php'); ?></title>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-primary">
                                        <div class="box-header">
                                            <h3 class="box-title" style=" color: black"><b>Discounts Report</b></h3>
                                        </div>
                                        <?php
                                            ...
                                            <table id="example2" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_POST['display'])) {
                                                        ...
                                                        if ($cat_id == 'all') {
                                                            $query = mysqli_query($con, "SELECT * FROM `discount_tb` INNER JOIN product ON product.prod_id =discount_tb.prod_id")or die(mysqli_error($con));
                                                        } else {
                                                            $query = mysqli_query($con, "SELECT * FROM `discount_tb` INNER JOIN product ON product.prod_id =discount_tb.prod_id AND discount_tb.prod_id ='$cat_id' ")or die(mysqli_error($con));
                                                        }

                                                        echo ' <center><h3 class="box-title" style=" color: black"><b><u>Discounts Report from ' . $start . ' to ' . $end . '</u></b></h3></center>';
                                                    }
                                                    while ($row = mysqli_fetch_array($query)){
                                                        ...
                                                        ?></td> 
                                                            <td><?php echo $row['price_before_disc']; ?></td>
                                                            <td><?php echo $row['discount_price']; ?></td>                                                          
                                                            <td><?php echo 100-(($row['discount_price']/ $row['price_before_disc']) * 100) .'%'; ?></td>                   
                                                            <td><?php echo 'From ' . $row['discount_from'] . ' To ' . $row['discount_to']; ?></td>
                                                        </tr>                                                 
                                                        <?php
                                                    }
