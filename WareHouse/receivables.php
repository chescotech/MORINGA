...
<?php
		$branch=$_SESSION['branch'];
		$query=mysqli_query($con,"select * from customer natural join sales natural join sales_details natural join term natural join product where balance<>0 and branch_id='$branch' and status<>'paid' order by cust_last desc")or die(mysqli_error($con));
		...
		<?php }?>			  
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th><h4><b><?php 
                        $querytotal=mysqli_query($con,"select SUM(balance) as total from customer where branch_id='$branch'")or die(mysqli_error($con));
