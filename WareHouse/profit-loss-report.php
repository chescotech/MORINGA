                                    ...
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-body">
                                            ...
                                            if (isset($_POST['display'])) {
                                                ...
                                                $query2 = mysqli_query($con, "SELECT SUM(qty * sales_details.price) AS Sales,SUM(qty * (sales_details.price-prod_price)) As NetSale FROM sales_details INNER JOIN sales ON "
