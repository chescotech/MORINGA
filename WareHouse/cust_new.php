                                    ...
                                    <div class="box-body">
                                        ...
                                        <form method="post" action="customer_add.php" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="date" class="col-sm-3 control-label">Account #</label>
                                                    <div class="input-group col-md-8">  
                                                        <input type="text" class="form-control pull-right" id="date" name="account_no" placeholder="Account #" required>
                                                    </div>
                                                </div>  
                                            </div>
