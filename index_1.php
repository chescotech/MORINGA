...
<html>
    ...
    <body class="hold-transition login-page">
        <div class="login-box" style="border: 2px solid white">
            <div class="login-logo">
                <b style="color: white">Chesco-Tech <br> <h4><u>Point Of Sale</u></h4></b>
            </div><!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg" style="color: black"><b>PLease Enter Password !</b></p>
