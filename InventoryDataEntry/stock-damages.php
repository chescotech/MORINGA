...
<html>
    <head>
        ...
        <title>Stock Damages List | <?php include('../dist/includes/title.php'); ?></title>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1>
                            <a class="btn btn-lg btn-warning" href="add-inventory.php">Add Stock Damage</a>
                        </h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                            <li class="active">Stock Damages</li>
                        </ol>
                    </section>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <h3 class="box-title">Stock Damages List</h3>
                                    </div>
                                    <div class="box-body">
