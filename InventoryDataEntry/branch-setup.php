...
<html>
    <head>
        ...
        <title>Branches | <?php include('../dist/includes/title.php'); ?></title>
                        ...
                        <div class="row">
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($con, "select * from stores_branch")or die(mysqli_error($con));
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="height:auto">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" method="post" action="branch-update.php" enctype='multipart/form-data'>

                                                                    <div class="form-group">
                                                                        <label class="control-label col-lg-3" for="name">Branch</label>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="height:auto">
                                                            ...
                                                            <div class="modal-body" hidden="">
                                                                <form class="form-horizontal" method="post" action="delete-branch.php" enctype='multipart/form-data'>
                                                                    <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        <!-- Date range -->
                                        <form method="post" action="add-branch.php" enctype="multipart/form-data">
