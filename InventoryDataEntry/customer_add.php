...
if($count > 0){
    ...
    mysqli_query($con, "INSERT INTO customer(cust_last,cust_first,email,cust_address,cust_contact,branch_id,balance,cust_pic) 
				VALUES('$last','$first','$email','$address','$contact','$branch','0','default.gif')")or die(mysqli_error($con));
