...
<html>
    <head>
        ...
        <title>Expenses Report | <?php include('../dist/includes/title.php'); ?></title>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-primary">
                                        <div class="box-header">
                                            <h3 class="box-title" style=" color: black"><b>Expenses Report</b></h3>
                                        </div>
                                        <?php
                                            ...
                                            <table id="example2" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_POST['display'])) {
                                                        ...
                                                        $query = mysqli_query($con, "SELECT * FROM expenses_tb WHERE date BETWEEN '$startDate' AND '$stop_date'  GROUP BY description")or die(mysqli_error($con));

                                                        echo ' <center><h3 class="box-title" style=" color: black"><b><u>Expense Report from ' . $start . ' to ' . $end . '</u></b></h3></center>';
                                                    } else {
                                                        $query = mysqli_query($con, "SELECT * FROM expenses_tb WHERE DATE(date) = DATE(NOW()) GROUP BY description")or die(mysqli_error($con));
                                                        echo ' <center><h3 class="box-title" style=" color: black"><b><u>Todays Expense Report</u></b></h3></center><br>';
                                                    }
                                                    while ($row = mysqli_fetch_array($query)) {
                                                        $totalSold += $row['amount'];
                                                        ?>
                                                        <tr>                     
