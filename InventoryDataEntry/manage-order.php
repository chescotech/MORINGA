...
<?php include('../dist/includes/header_admin.php'); ?>
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($row = mysqli_fetch_array($query)){
                                                                    ...
                                                                    $total = $productrow['prod_sell_price'] * $row['qty'];
                                                                    $unitPrice = $productrow['prod_sell_price'] / $row['qty'];
                                                                    $grand = $grand + $total;
                                                                    $customer_name = $row['customer_name'];
                                                                    ?>
                                                                    <tr >
                                                                        <td><?php echo $row['qty']; ?></td>
                                                                        <td class="record"><?php echo $productrow['prod_name']; ?></td>
                                                                        <td><?php echo number_format($productrow['prod_sell_price'], 2); ?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="delete-draft.php" enctype='multipart/form-data'>
          <input type="hidden" class="form-control" name="cid" value="<?php echo $cid;?>" required>   
          <input type="hidden" class="form-control" id="price" name="id" value="<?php echo $row['temp_trans_id'];?>" required>  
        <p>Are you sure you want to remove <?php echo $productrow['prod_name'];?>?</p>
