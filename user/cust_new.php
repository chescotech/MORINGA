                                    ...
                                    <form method="post" action="customer_add.php" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-md-8">
                                                    <input type="text" class="form-control pull-right" id="date" name="first" placeholder="Company Name" required>
                                                </div><!-- /.input group -->
                                            </div><!-- /.form group -->
                                        </div>
                                        ...
                                        <div class="col-md-6" hidden="">
                                            <div class="form-group">
                                                ...
                                                <div hidden="">
                                                    <input type="text" class="form-control pull-right" id="date" name="type" value="<?php echo $type; ?>">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="date" class="col-sm-3 control-label">TPIN #</label>
                                                <div class="input-group col-md-8">
                                                    <input type="text" class="form-control pull-right" id="date" name="account_no" placeholder="TPIN #" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="date" class="col-sm-3 control-label">Type of Customer</label>
                                                <select class="form-control select2" name="price_tag" tabindex="1">
                                                    <option value="none">--Select Price Tag --</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="date" class="col-sm-3 control-label">Email Address</label>
                                                <div class="input-group col-md-8">
                                                    <textarea class="form-control pull-right" id="date" name="email" placeholder="Email Address"></textarea>
                                                </div>
                                            </div>
                                        </div>
