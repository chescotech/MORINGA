...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <a class = "btn btn-primary btn-print" href = "cash_transaction.php"><i class ="glyphicon glyphicon-arrow-left"></i><button style=" background-color: green ">NEXT SALE</button></a>

    <body onload="window.print()">
        <div class="wrapper">
            <div class="body">
                <center><p style="font-size: 25px; font-family: Arial; color: blue">
                        <b>
                            <?php
                ...
                <center><a style=" color: black; font-size: 15px; font-family: Arial"><b> Payment Invoice # <?php
                            echo $invoiceNo;
                            ?>
                        </b></a></center>  
                ...
                <div class="payslip2">
                    <div class="payslip2_">       
                        <div class="payslip">
                            <p style="font-size: 15px; font-family: Arial"><b>TPIN :</b> 1003887720</p></td>
                            <p style="font-size: 15px; font-family: Arial"><b>Order Number:</b> 
                                <?php
                                echo $cust_order_no;
                                ?>                            
                            </p></td>
                            <p style="font-size: 15px; font-family: Arial"><b>Receipt Date: </b><?php
                                echo date("M d, Y");
                                ?></p>
                            <p style="font-size: 15px; font-family: Arial"><b>Mode Of Payment:</b> Cash.</p>
                        </div>
                        <style type="">
                            .align{
                        ...
                        <p style="font-size: 15px; font-family: Arial"><b>
                                Address: <?php echo $customerRows['cust_address'] ?>
                            </b>
                        </p>  
                        <p style="font-size: 15px; font-family: Arial"><b>
                        ...
                        <br>
                            ...
                            <table style=" margin-left: -10px">
                                <tr>
                                    ...
                                    <th style="font-size: 15px; font-family: Arial">PACK SIZE</th>
                                    <th style="font-size: 15px; font-family: Arial">UNIT PRICE</th> 
                                    <th style="font-size: 15px; font-family: Arial">TOTAL</th> 
