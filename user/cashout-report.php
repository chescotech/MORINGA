                                ...
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <div> <?php
                                                ...
                                                $company = new Company();
                                                //echo $company->tPin($con); 
                                                ?> </div>
                                        <h3 class="box-title" style=" color: black"><b>Your Cash Out Report</b></h3>
                                    </div>
                                    <?php
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="example2" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $query = mysqli_query($con, "SELECT sales.amount_due, sales.discount,description,user.branch_id_user  AS stock_branch_id,SUM(qty) AS qty,prod_name,prod_desc,name,price AS prod_sell_price,sales.date_added 
                                                            FROM sales_details 
