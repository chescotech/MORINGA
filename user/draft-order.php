                ...
                <section class="content">
                        ...
                        <div class="col-md-9">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Invoice Transaction</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
                                    <form method="post" action="transaction-add-draft.php">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control pull-right" id="date"
                                                            name="barcode" placeholder="Barcode" tabindex="2" value=""
                                            ...
                                            <div class="modal-content" style="height:auto">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" method="post"
                                                        action="add-to-bill-credit.php" enctype='multipart/form-data'>
                                                        <div class="col-md-12">
                                                        </div>
                  ...
                  ?>
                      ...
                      $query = mysqli_query($con, "select * from draft_temp_trans LEFT JOIN product ON product.prod_id=draft_temp_trans.prod_id"
                        . " where draft_temp_trans.branch_id='$branch' AND draft_temp_trans.order_no='0' AND user_id='$user_id' ") or die(mysqli_error($con));
                      $grand = 0;
                      $totalDiscount = 0;
                      $newPrice = 0;
                      ...
                      ?>
                                            <tr>
                                              ...
                                              ?></td>
                                                <td><?php  echo number_format($row['price'], 2) . ' ( ' . $DAO->getCustomerType($con, $selected_cust_id) . ' ) ';  ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#delete<?php echo $row['temp_trans_id']; ?>"
                                                        data-target="#delete<?php echo $row['temp_trans_id']; ?>"
                                                        data-toggle="modal" style="color:#fff;"
                                                        class="small-box-footer"><i
                                                            class="glyphicon glyphicon-trash text-red"></i></a>

                                                </td>
                                                <td>
                                                    <a href="#discount<?php echo $row['temp_trans_id']; ?>"
                                                        data-target="#discount<?php echo $row['temp_trans_id']; ?>"
                                                        data-toggle="modal" style="color:#fff;"
                                                        class="small-box-footer"><i style="font-size:20px;"
                                                            class="glyphicon glyphicon-record text-red"></i>
                              ...
                              ?>
                                            ...
                                            <div id="delete<?php echo $row['temp_trans_id']; ?>" class="modal fade in"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content" style="height:auto">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post"
                                                                action="delete-draft.php" enctype='multipart/form-data'>
                                                                <input type="hidden" class="form-control" name="cid"
                                                                    value="<?php echo $cid; ?>" required>
                                                                <input type="hidden" class="form-control" id="price"
                                                                    name="id"
                                            ...
                                            <!--end of modal-->
                                            <div id="discount<?php echo $row['temp_trans_id']; ?>" class="modal fade in"
                                                tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content" style="height:auto">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post"
                                                                ...
                                                                <input class="form-control" id="price" name="amount"
                                                                    required autocomplete="off">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form method="post" name="autoSumForm" action="draft-sales-add.php">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="text-align:right" class="form-control" id="amount_due"
                                            name="discount" placeholder="Amount Due"
                                            value="<?php echo $totalDiscount; ?>" readonly>
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <label for="date">Date To Be Collected</label>

                                        <input type="date" style="text-align:right" class="form-control" id="amount_due"
                                            name="date2collect">
                            ...
                            <button class="btn btn-lg btn-block btn-primary" id="daterange-btn" name="cash"
