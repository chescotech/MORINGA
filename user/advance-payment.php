                ...
                <div class="container">
                    ...
                    <section class="content-header">
                        <h1>
                            ...
                            <a class="btn btn-lg btn-primary" href="advance-sale.php"  style="color:#fff;" class="small-box-footer">New Advance Sale <i class="glyphicon glyphicon-plus text-blue"></i></a>
                        </h1>
                        <ol class="breadcrumb">
                            ...
                            <div class="col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <h3 class="box-title" style=" color: black"><b>Advance Sales List</b></h3>
                                    </div>
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $totalAmountDue = 0;
                                                $query = mysqli_query($con, "SELECT status,amount,customer_name,order_no,qty,price,SUM(qty) AS totalqty,SUM(price) AS total FROM `advance_payments_tb` WHERE order_no!='0'  GROUP BY order_no")or die(mysqli_error($con));
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="advance-reciept-print.php?orderno=<?php echo $row['order_no']; ?>" style="color: #003eff "><b>Print Receipt</b></i></a>
                                                        </td>        
                                                         ...
                                                         <td>
                                                             ...
                                                             if($status=="Sold"){
                                                                 ...
                                                                 echo '<a href="sale-advance-reciept.php?orderno='.$orderNo.' " style="color: #003eff "><b>Sale</b></i></a>';
                                                             }
                                                             ?>                                                            
