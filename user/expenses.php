                                    ...
                                    <div class="box-body">
                                        ...
                                        <form method="post" action="add_expense.php" enctype="multipart/form-data">                                            
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="name" tabindex="1" onchange='CheckColors(this.value);'>
                                                <?php                                               
                                                $query2=mysqli_query($con,"select * from expense_types_tb")or die(mysqli_error($con));
                                                while($row=mysqli_fetch_array($query2)){                                                                                                                  
                                                ?>
                                                    <option value="<?php echo $row['exp_name'];?>"><?php echo $row['exp_name'];?></option>
                                                    <option value="others">Other Expenses</option>
                                                  <?php                                                  
                                                }?>
                                             </select>
                                                <input type="text" class="form-control pull-right" name="others" id="othercolor" value="" style='display:none;'/>
                                            </div>
                                          
                                            <div class="form-group">
                                                <label for="date">Expense Amount</label>
                                                <div class="input-group col-md-12">
                                                    <input type="text" class="form-control pull-right" id="date" name="amount" placeholder="Expense Amount" required autocomplete="off">
                                                </div><!-- /.input group -->
                                            </div><!-- /.form group -->
