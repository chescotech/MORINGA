...
<?php
	...
	mysqli_query($con,"INSERT INTO history_log(user_id,action,date) VALUES('$id','$remarks','$date')")or die(mysqli_error($con));
        ...
        // update the logout time for user in the sales... 
        
        mysqli_query($con,"UPDATE open_close_cashout_tb SET logout='$date',status='closed' WHERE user_id='$id' AND status='' ")or die(mysqli_error($con));
