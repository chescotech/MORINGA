                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="incomplete-draft-reciept_latest.php?orderno=<?php echo $row['order_no']; ?>" style="color: #003eff "><b>Print Latest </b></i></a> |
                                                        <a href="incomplete-draft-reciept.php?orderno=<?php echo $row['order_no']; ?>" style="color: #003eff "><b>Print All</b></i></a>
                                                    </td>
                                                    <td>
