...
<a class="btn btn-primary btn-print" href="quotations.php"><i class="glyphicon glyphicon-arrow-left"></i><button style=" background-color: green ">BACK</button></a>
                    ...
                    <table border="0" align="center" width="10000">
                        ...
                        <center>
                            <h4 style="color: blue"><b>
                                    ...
                                    $quote_number = $quote_id; //$quotaton_rows['quote_id'];
                                    ?>
                                </b>
                            </h4>
                        </center>
                        ...
                        $query_ = mysqli_query($con, "select * from quotation_tb LEFT "
                                . "join product on product.prod_id=quotation_tb.prod_id WHERE quote_id='$quote_id'") or die(mysqli_error($con));
                        $customers_rows = mysqli_fetch_array($query_);
                        $customer = $customers_rows['customer'];
                        ...
                        echo ' <tr>
                                                            <td class="box" width=""><p><u></u>
                                                                        Quotation To: ' . $customer . '&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
