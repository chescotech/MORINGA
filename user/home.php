                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            if (mysqli_num_rows($query3) > 0) {
                                                echo '  <a href="../user/product-shortages.php"><div class="col-lg-4 col-xs-6" style=" color: white">                                               
                                                <div class="small-box bg-red-active">
                                                    ...
                                                    <a href="../user/product-shortages.php" class="small-box-footer">
                                                        Go <i class="fa fa-arrow-circle-right"></i>
                                                    </a>
                                                </div>
                                            </div></a>';
                                            ...
                                            $row3 = mysqli_fetch_array($query3);
                                            if (mysqli_num_rows($query3) > 0) {
                                                echo '  <a href="../user/draft-sale.php"><div class="col-lg-4 col-xs-6" style=" color: white">                                               
                                                <div class="small-box bg-red-active">
                                                    <div class="inner">
                                                        <h3 style=" color: white">
                                                           '.$row3['prodcount'].'
                                                            </h3>
                                                        <p style=" color: white">Pending Draft Payments</p>
                                                    </div>
                                                    <div class="icon" style="margin-top:10px">
                                                        <i class="glyphicon glyphicon-alert"></i>
                                                    </div>
                                                    <a href="../user/draft-sale.php" class="small-box-footer">
                                                        Go <i class="fa fa-arrow-circle-right"></i>
                                                    </a>
                                                </div>
                                            </div></a>';
                                            ...
                                            $row3 = mysqli_fetch_array($query3);
                                            if (mysqli_num_rows($query3) > 0) {
                                                echo '  <a href="product.php"><div class="col-lg-4 col-xs-6" style=" color: white">                                               
                                                <div class="small-box bg-red-active">
                                                    <div class="inner">
                                                        <h3 style=" color: white">
                                                           ' . $row3['prodcount'] . '
