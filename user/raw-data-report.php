...
<html>
    ...
    <body class="hold-transition skin-<?php echo $_SESSION['skin']; ?> layout-top-nav">
      ...
      $query = mysqli_query($con, "SELECT * FROM `rawdata_updates_tb` INNER JOIN rawdata_tb ON rawdata_tb.id=rawdata_updates_tb.item_id"
              . " AND date_added BETWEEN '$startDate' AND '$stop_date'  ")or die(mysqli_error($con));
                                                        ...
                                                        $query = mysqli_query($con, "SELECT * FROM `rawdata_updates_tb` INNER JOIN rawdata_tb "
                                                                . "ON rawdata_tb.id=rawdata_updates_tb.item_id AND DATE(date_added) = DATE(NOW()) GROUP BY status,item_id  ")or die(mysqli_error($con));
                                                        echo ' <center><h3 class="box-title" style=" color: black"><b><u>Todays Raw DATA Entries Report</u></b></h3></center><br>';
                                                    }
