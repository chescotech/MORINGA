        ...
        <div class="wrapper">
            <div class="body">
                <center>
                    ...
                    <img src="../dist/img/my-logo.png"></img>
                    ...
                    $query = mysqli_query($con, "SELECT * FROM `sales` INNER JOIN modes_of_payment_tb on modes_of_payment_tb.payment_mode_id=sales.modeofpayment WHERE sales_id ='$sales_id'  ")or die(mysqli_error($con));
