...
<html>
                                ...
                                <form method="post">                                         
                                    <div class="col-lg-2">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" name="prod_id" required >    
                                            ...
                                            <?php
                                            $queryc = mysqli_query($con, "select prod_name,prod_id from product")or die(mysqli_error());
                                            while ($rowc = mysqli_fetch_array($queryc)) {
                                                ?>
                                                <option value="<?php echo $rowc['prod_name']; ?>"><?php echo $rowc['prod_name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" name="branch" required >    
                                            ...
                                            <?php
                                            $queryc = mysqli_query($con, "select * from stores_branch")or die(mysqli_error());
                                            while ($rowc = mysqli_fetch_array($queryc)) {
                                                ?>
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title" style=" color: black"><b> 
                                            <?php
                                            $querycount = mysqli_query($con, "SELECT COUNT(prod_id) AS norecords FROM `product`")or die(mysqli_error());
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                // echo '$prodId '.$prodId.'$branch '.$branch;

                                                if ($prodId == "all" && $branch == "all") {
                                                    $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                            ...
                                                            . "  INNER JOIN exchange_rates_tb ON exchange_rates_tb.exchange_id = product.currency_id  ")or die(mysqli_error());
                                                } else if ($prodId != "all" && $branch == "all") {
                                                    $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                            . " join category  "
                                                            . "INNER JOIN stores_branch ON stores_branch.id=product.stock_branch_id"
                                                            . " INNER JOIN exchange_rates_tb ON exchange_rates_tb.exchange_id = product.currency_id WHERE prod_name='$prodId'")or die(mysqli_error());
                                                } else if ($prodId == "all" && $branch != "all") {
                                                    $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                            . " join category  "
                                                            . "INNER JOIN stores_branch ON stores_branch.id=product.stock_branch_id"
                                                            . " INNER JOIN exchange_rates_tb ON exchange_rates_tb.exchange_id = product.currency_id WHERE stock_branch_id='$branch'")or die(mysqli_error());
                                                } else {
                                                    $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                            . " join category  "
                                                            . "INNER JOIN stores_branch ON stores_branch.id=product.stock_branch_id"
                                                            . " INNER JOIN exchange_rates_tb ON exchange_rates_tb.exchange_id = product.currency_id WHERE prod_name='$prodId' AND stock_branch_id='$branch'  ")or die(mysqli_error());
                                                }
                                            } else {

                                                $query = mysqli_query($con, "select * from product natural join supplier natural join category"
                                                        . " INNER JOIN stores_branch ON stores_branch.id=product.stock_branch_id"
                                                        . " INNER JOIN exchange_rates_tb ON exchange_rates_tb.exchange_id = product.currency_id order by prod_id DESC LIMIT 5")or die(mysqli_error());
                                            }
                                            ...
                                            if ($damageCount > 0) {
                                                ...
                                                ?></td>
                                                    ...
                                                    <td>
                                                        <a href="#transfer<?php echo $row['prod_id']; ?>" data-target="#transfer<?php echo $row['prod_id']; ?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-transfer text-blue"></i></a>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post" action="product_update.php" enctype='multipart/form-data'>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <select class="form-control select2" style="width: 100%;" name="supp" required>
                                                                            <option value="<?php echo $row['supplier_id']; ?>"><?php echo $row['supplier_name']; ?></option>
                                                                            <?php
                                                                            $queryc = mysqli_query($con, "select * from supplier order by supplier_name")or die(mysqli_error());
                                                                            while ($rowc = mysqli_fetch_array($queryc)) {
                                                                                ?>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <input type="text" class="form-control" id="price" name="barcode" value="<?php echo $row['barcode']; ?>" required>  
                                                                    </div>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label class="control-label col-lg-3" for="price">Expire Date.</label>
                                                                    <div class="col-lg-9">
                                                                        <input type="text" class="form-control" id="dateexpire" name="expire_date" value="<?php
                                                                            echo $row['expire_date'];
                                                                            ?>" placeholder="Year-Month-Day" autocomplete="">  
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <select class="form-control select2" style="width: 100%;" name="vat_status" required>
                                                                            <option value="<?php echo $row['vat_status']; ?>"><?php echo $row['vat_status']; ?></option>
                                                                            <option value="inclusive">Vat Inclusive</option>
                                                                            <option value="free">VAT Free</option>
                                                                        </select>
                                                                    </div><!-- /.input group -->
                                                                </div><!-- /.form group -->
                                                                ...
                                                                <div class="form-group" hidden="">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <select class="form-control select2" style="width: 100%;" name="belongs_to" required>
                                                                            ...
                                                                            <?php
                                                                            $queryc = mysqli_query($con, "select * from shop_category_tb")or die(mysqli_error());
                                                                            while ($rowc = mysqli_fetch_array($queryc)) {
                                                                                ?>
                                                                ...
                                                                <div class="form-group" >
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <select class="form-control select2" style="width: 100%;" name="ex_id" required>              
                                                                            <option value="<?php echo $row['exchange_id']; ?>"><?php echo $row['name']; ?></option>
                                                                            <?php
                                                                            $queryc = mysqli_query($con, "select * from exchange_rates_tb")or die(mysqli_error());
                                                                            while ($rowc = mysqli_fetch_array($queryc)) {
                                                                                ?>
                                                                                <option value="<?php echo $rowc['exchange_id']; ?>"><?php echo $rowc['name']; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </div><!-- /.input group -->
                                                                </div><!-- /.form group -->
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content" style="height:auto">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <?php
                                                            $discountQuery = mysqli_query($con, "select * FROM discount_tb WHERE prod_id='$prod_d' ")or die(mysqli_error());
                                                            $discountrow = mysqli_fetch_array($discountQuery)
                                                            ?>                                                                
                                            ...
                                            <div id="transfer<?php echo $row['prod_id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content" style="height:auto">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span></button>
                                                            <h4 class="modal-title" style=" color: black"><b>
             <?php echo 'Transfer ' . $row['prod_name'] . '  '; ?>
                                                                </b>
                                                            </h4>
                                                        </div>
                                                        <div class="modal-body">
                                                                    ...
                                                                    $discountrow = mysqli_fetch_array($discountQuery)
                                                                    ?>                                                                
                                                            <form class="form-horizontal" method="post" action="branch_to_branch_transfer.php" enctype='multipart/form-data'>
    ...
    while ($rowc = mysqli_fetch_array($queryc)) {
        ?>
                                                                ...
                                                                <div class="form-group" >
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <select class="form-control select2" style="width: 100%;" name="transfer_to" required>                                                                                
    <?php
    $current_store = $row['stock_branch_id'];
    //echo 'id'.current_store;
    $queryc = mysqli_query($con, "select * from stores_branch WHERE id !='$current_store'  ")or die(mysqli_error());
    while ($rowc = mysqli_fetch_array($queryc)) {
        ?>
                                                                                <option value="<?php echo $rowc['id']; ?>"><?php echo $rowc['branch_name']; ?></option>
                                                                            <?php } ?>
    ...
    while ($rowc = mysqli_fetch_array($queryc)) {
        ?>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-lg-3" for="name">Quantity to Transfer</label>
                                                                    <div class="col-lg-9">
                                                                        <input type="text" class="form-control" id="name" autocomplete="off"  name="quantity"required>  
                                                                    </div>
                                                                </div>                                                                 
                                                        </div>
                                                        <br></br>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="product_add.php" enctype='multipart/form-data'>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" required>  
                                <input type="text" class="form-control" id="datepicker3" name="expire_date" placeholder="mm/dd/yyyy" autocomplete="off">  
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" required>  
                                <input type="text" class="form-control" id="datepicker2" name="manufactor_date" placeholder="mm/dd/yyyy" autocomplete="off">  
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3" for="file">Currency</label>
                            <div class="col-lg-9">
                                <select class="form-control select2" style="width: 100%;" name="currency" required>
                                    <?php
                                    $query3 = mysqli_query($con, "select * from exchange_rates_tb order by name DESC")or die(mysqli_error());
                                    while ($row3 = mysqli_fetch_array($query3)) {
                                        ?>
                                        <option value="<?php echo $row3['exchange_id']; ?>"><?php echo $row3['name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3" for="file">Vat Status</label>
                            <div class="col-lg-9">
                                <select class="form-control select2" style="width: 100%;" name="vat_status" required>
                                    <option value="inclusive">Vat Inclusive</option>
                                    <option value="free">VAT Free</option>
