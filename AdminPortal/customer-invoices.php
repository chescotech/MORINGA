                                    ...
                                    <form method="post">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="branch_id" required >
                                                <option value="all_branches">All Customers</option>
                                                <?php
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_POST['display'])) {
                                                        ...
                                                        if ($branch_id != "all_branches") {
                                                            $query = mysqli_query($con, "SELECT date_added,invoice_no,amount_due, customer.cust_first,customer.cust_last,sales.sales_id FROM `sales` inner join customer on customer.cust_id=sales.customer_id
                                                            WHERE date_added BETWEEN '$startDate' AND '$stop_date' AND sales.customer_id='$branch_id' ")or die(mysqli_error($con));
                                                        } else {
                                                    ...
                                                    while ($row = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>                     
                                                            ...
                                                            <td>
                                                                <a href="receipt.php?invoice_no=<?php echo $row['invoice_no']; ?>&sales_id=<?php echo $row['sales_id']; ?>" style="color: #003eff "><b>View Invoice</b></i></a>
                                                            </td>
                                                            <td>
                                                                <a href="delete-invoice.php?invoice_no=<?php echo $row['invoice_no']; ?>&sales_id=<?php echo $row['sales_id']; ?>" style="color: #003eff "><b>Delete Invoice</b></i></a>
                                                            </td>
                                                        </tr>                                                 
                                                            <?php
                                                        }
