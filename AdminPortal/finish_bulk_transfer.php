...
$branch = $_SESSION['branch_id_user'];
$user_id = $_SESSION['id'];
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <form method="POST" action="#transfer">
                                        ...
                                        $q1 = mysqli_query($con, "SELECT * FROM trans_temp 
                                            INNER JOIN ware_house_tb WHERE ware_house_tb.prod_id = trans_temp.prod_id
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <select class="form-control select2" style="width: 100%;" name="stock_branch_id" required>
                                                    <?php
                                                    $queryc1 = mysqli_query($con, "SELECT * FROM stores_branch") or die(mysqli_error($con));
                                ...
                                if (isset($_POST['transfer_'])) {
                                    ...
                                    array_map(function ($prod_id, $prr_name, $qty) {
                                        global $con, $stock_branch_id, $user_id, $branch, $branch_name, $DAO;
                                        ...
                                        // Update ware-house-stock qty
                                        mysqli_query($con, "UPDATE ware-house-stock set prod_qty=prod_qty-'$qty' WHERE prod_id='$prod_id' ") or die("33 " . mysqli_error($con));
