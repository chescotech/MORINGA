...
<html>
                                    ...
                                    <form autocomplete="off" method="post">                                         
                                        <div class="col-lg-2">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="prod_id" required >    
                                                ...
                                                <?php
                                                $queryc = mysqli_query($con, "select prod_name,prod_id from product")or die(mysqli_error($con));
 ...
 <a class="btn btn-lg btn-primary" href="bulk_transfer_alt.php" style="color:#fff;" class="small-box-footer">Bulk Transfer <i class="glyphicon glyphicon-infinity text-blue"></i></a>
                                            ...
                                            if (isset($_POST['search'])) {
                                                ...
                                                if ($prodId == "all" && $branch != "all") {
                                                    ...
                                                    $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                            ...
                                                            . " AND stock_branch_id='$branch'  ")or die(mysqli_error());

                                                    // echo 'here'.$branch.' product'.$prodId;
                                                    //echo '$prodId '.$prodId.' '.$branch ;
                                                } else if ($prodId != "all" && $branch == "all") {

                                                    $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                            . " join category  "
                                                            . "INNER JOIN stores_branch ON stores_branch.id=product.stock_branch_id"
                                                            . " AND prod_name='$prodId'  ")or die(mysqli_error());
                                                } else if ($prodId != "all" && $branch != "all") {

                                                    $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                            . " join category  "
                                                            . "INNER JOIN stores_branch ON stores_branch.id=product.stock_branch_id"
                                                            . " AND stock_branch_id='$branch' AND prod_name='$prodId'  ")or die(mysqli_error());
                                                } else {
                                                    $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                            . " join category  "
                                                            . "INNER JOIN stores_branch ON stores_branch.id=product.stock_branch_id"
                                                ...
                                                $query = mysqli_query($con, "select * from product natural join supplier natural"
                                                        . " join category  "
                                                        . "INNER JOIN stores_branch ON stores_branch.id=product.stock_branch_id AND branch_id='$branch' order by prod_id DESC LIMIT 5 ")or die(mysqli_error());
                                            }
                                            ...
                                            if ($damageCount > 0) {
                                                ...
                                                ?></td>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        ?></td>
                                                    <td><?php
                                                        echo "Retail Price : " . number_format($row['prod_sell_price'], 2)
                                                        . '<br>' . 'Whole Sale:' . number_format($row['wholesale_price'], 2)
                                                        . '<br>' . 'Discount Price:' . number_format($row['discount_price'], 2)
                                                        . '<br>' . 'Special Price:' . number_format($row['special_price'], 2)
                                                        ;
                                                        ?></td>
                                                    <td><?php
    ...
    while ($row2 = mysqli_fetch_array($query2)) {
        ?>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <input type="text" class="form-control" id="price" name="pack_size" value="<?php echo $row['pack_size']; ?>" required>  
                                                                    </div>
                                                                </div> 
    ...
    while ($rowc = mysqli_fetch_array($queryc)) {
        ?>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <input type="text" class="form-control" id="price" name="prod_qty" value="<?php echo $row['prod_qty']; ?>" required>  
                                                                    </div>
                                                                </div>
                                                                <div class="form-group" hidden="">
...
while ($row2 = mysqli_fetch_array($query2)) {
    ?>
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3" for="price">Unit</label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" id="price" name="pack_size" placeholder="Unit" required>  
                            </div>
                        </div> 
