...
if ($count > 0) {
    ...
    mysqli_query($con, "INSERT INTO ware_house_tb(barcode,prod_name,prod_price,prod_desc,prod_pic,cat_id,supplier_id,branch_id,serial,prod_qty,prod_sell_price,warehouse_id,wholesale_price,discount_price,special_price)
			VALUES('$barcode_scanned','$name','$price','$desc','$pic','$category','$supplier','$branch','$serial','$prod_qty','$prod_sell_price','$warehouse','$wholesale_price','$discount_price','$special_price')")or die(mysqli_error($con));
