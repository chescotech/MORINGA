...
mysqli_query($con, "update product set prod_name='$name',prod_price='$price',
	prod_qty ='$prod_qty',supplier_id='$supplier',cat_id='$category',"
                ...
                . " prod_sell_price='$prod_sell_price', wholesale_price='$wholesale_price'"
                . ",discount_price='$discount_price', special_price='$special_price',pack_size='$pack_size',barcode='$barcode'  where prod_id='$id'")or die(mysqli_error($con));
