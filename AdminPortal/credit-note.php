...
<html>
    ...
    $query = mysqli_query($con, "SELECT * FROM `sales` INNER JOIN modes_of_payment_tb on modes_of_payment_tb.payment_mode_id=sales.modeofpayment WHERE invoice_no ='$invoiceNumber'  ")or die(mysqli_error($con));
   ...
   " . $change_words[$amount_after_decimal % 10]) . ' Paise' : '';
    ...
    <center>
        ...
        <a class = "btn btn-primary btn-print" href = "input-reversal.php"><i class ="glyphicon glyphicon-arrow-left"></i> |  Back</a>
    </center>
    <br></br>
    <head>
        <meta charset="utf-8">
            ...
            <table class="inventory">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        // update the stock to reverse the quantities where they were..
