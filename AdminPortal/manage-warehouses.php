...
<html>
    <head>
        ...
        <title>Warehouses | <?php include('../dist/includes/title.php'); ?></title>
                        ...
                        <div class="row">
                            <div class="col-xs-9">
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <h3 class="box-title">Warehouse Setup</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($con, "select * from warehouses")or die(mysqli_error($con));
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" method="post" action="" enctype='multipart/form-data'>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-lg-3" for="name">Warehouse</label>
                                                                        <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['id']; ?>" required>  
                                                                            <input type="text" class="form-control" id="name" name="branch_name" value="<?php echo $row['name']; ?>" required>  
                                                                        </div>
                                                                    </div> 
                                                            </div><hr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="height:auto">
                                                            ...
                                                            <div class="modal-body" hidden="">
                                                                <form class="form-horizontal" method="post" action="delete-warehouse.php" enctype='multipart/form-data'>
                                                                    <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        <!-- Date range -->
                                        <form method="post" action="add-warehouse.php" enctype="multipart/form-data">

                                            <div class="form-group">
                                                <label for="date">Warehouse Name</label>
                                                <div class="input-group col-md-12">
                                                    <input type="text" class="form-control pull-right" id="date" name="name" placeholder="Enter Branch Name" required>
                                                </div><!-- /.input group -->
                                            </div><!-- /.form group -->
