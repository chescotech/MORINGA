                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($con, "SELECT * FROM sales_tb INNER JOIN product ON sales_tb.item_sold_id =product.prod_id")or die(mysqli_error($con));
                                                while ($row = mysqli_fetch_array($query)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $Objects->getUserDetailsById($con,$row['added_by']); ?></td>                                                       
