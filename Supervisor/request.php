...
<?php
		...
		$query=mysqli_query($con,"select * from purchase_request natural join product natural join supplier where branch_id='$branch' order by request_date")or die(mysqli_error($con));
