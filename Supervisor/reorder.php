...
<?php
		...
		$query=mysqli_query($con,"select * from product natural join supplier natural join category where branch_id='$branch' and prod_qty<=reorder order by prod_name")or die(mysqli_error($con));
