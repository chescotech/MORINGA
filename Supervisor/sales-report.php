                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_POST['display'])) {
                                                        ...
                                                        if ($cat_id != 'all' && $branch_id!='all_branches'){                                                            
                                                            $query = mysqli_query($con, " SELECT stock_branch_id,SUM(qty) AS qty,prod_name,prod_desc,name,prod_sell_price "
                                                                    ...
                                                                    . "AND product.stock_branch_id='$branch_id'  GROUP BY prod_name,stock_branch_id  ")or die(mysqli_error($con));
